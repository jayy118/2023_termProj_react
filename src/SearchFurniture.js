...
class SearchFurniture extends React.Component {
    constructor(props) {
        super(props);
        this.state = { item: {title: "", type: "", userId:"", brand: ""} };
        this.search = props.search;
        this.print =  props.componentDidMount;
    }
        ...
        return (
            <div style={{margin: "20px", paddingTop: "20px", paddingBottom: "20px", border: "1px solid"}} hidden={this.props.value !== this.props.index}>
                <div style={{ marginBottom: "10px"}}>
                    ...
                    />
                    <button style={{marginLeft: '20px', backgroundColor: 'greenyellow', border: "none"}} onClick={this.onButtonClick}> 제품 검색 </button>
                </div>
                <div style={{ marginBottom: "10px"}}>
